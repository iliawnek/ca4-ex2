...
control reset ir cond ready = (ctlstate,start,ctlsigs)
  where
      ...
      ctl_alu_a   = orw [st_instr_fet,st_load0,st_loadxi0,st_loadxi3,st_store0,st_lea0,
                         st_cmpeq,st_cmplt,st_cmpgt,st_jumpf0,st_jal0]
      ctl_alu_b   = orw [st_instr_fet,st_load0,st_loadxi0,st_loadxi3,st_store0,st_lea0,
                         st_sub,st_cmpeq,
      ...
      ctl_pc_ld   = orw [st_instr_fet,st_load0,st_loadxi0,st_lea0,st_store0,
                           st_jumpt0,st_jumpt1,st_jumpf0,st_jumpf1,
                           st_jump0,st_jump1,st_jal0,st_jal1]
      ctl_pc_ad   = orw [st_jal1]
      ctl_ad_ld   = orw [st_load0,st_loadxi0,st_load1,st_loadxi1,st_lea0,st_store0,
                         st_store1,st_jumpt0,st_jumpf0,st_jump0,
                         st_jump1,st_jal0,st_jal1]
      ctl_ad_alu  = orw [st_load1,st_loadxi1,st_store1,st_jump1,st_jal1]
      ctl_ma_pc   = orw [st_instr_fet,st_load0,st_loadxi0,st_lea0,st_store0,
