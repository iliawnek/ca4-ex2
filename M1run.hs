      ...
      simoutput =
        [
         ...
         string "\n\nControl signals\n  ",
           ...
           string "  ctl_rx_ld     = ", bit (ctl_rx_ld ctlsigs),
           string "  ctl_ry_ld     = ", bit (ctl_ry_ld ctlsigs),
           string "\n  ",
           ...
           string "  ctl_rf_prod   = ", bit (ctl_rf_prod ctlsigs),
           string "  ctl_rf_inc    = ", bit (ctl_rf_inc ctlsigs),
...
-- it in the simulation driver state
         ...
         fmtIf (orw [st_lea1 ctlstate, st_load1 ctlstate, st_store1 ctlstate,
                     ...
                     st_jal1 ctlstate, st_loadxi1 ctlstate])
